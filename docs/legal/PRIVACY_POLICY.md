...
Smart Warning is provided by Idefenda Lab, which is responsible for the personal data described in this policy. For any privacy question, or to exercise the rights below, contact jobarick@gmail.com or +255 713 455 454.

Your employer or the organization whose team code you joined decides who in that organization can see your information. Idefenda Lab operates the Service on their behalf.
...
## Location — when it is and is not collected
...
We do not sell personal data. It is shared only with:
